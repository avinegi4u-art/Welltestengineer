...
| `dst-pressure-transient-analysis-pro-v2.10.html` | **DST PTA Pro v2.10** (open this one) — reservoir-aware Bayesian posteriors, refined multilayer inversion, sparse boundary confidence, office/reserves sign-off workflow, auditable curve dominance |
...
| `dst-pressure-transient-analysis.html` | Older DST analyzer v2.0 — superseded by Pro v2.10 |
