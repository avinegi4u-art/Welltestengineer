...
| `casing-design-pro-v3.html` | **Casing Design Pro v7** — Phase B: connection VME (ISO ellipse), rating vs load design lines, 22 regression benchmarks; plus v6 buckling/bending/packer loads and audit trace |
