...
| `dst-pressure-transient-analysis-pro-v2.9.html` | **DST PTA Pro v2.9** (open this one) — Bayesian credible intervals, fitted multilayer inversion, sparse late-time boundary confidence, reserves-vs-screening usage matrix, raw/deconvolved/calibrated curve dominance |
...
| `dst-pressure-transient-analysis.html` | Older DST analyzer v2.0 — superseded by Pro v2.9 |
