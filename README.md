...
| `dst-pressure-transient-analysis-pro-v2.12.html` | **DST PTA Pro v2.12** (open this one) — interactive Plotly charts (zoom/pan/select-fit, hover, spikes) with SVG offline fallback, denser UI, plus v2.11 engineering suite |
| `dst-pressure-transient-analysis-pro-v2.11.html` | DST PTA Pro v2.11 — physics Bayesian, evidence inversion, shut-in guidance, engineering audit trail, office sign-off |
...
| `dst-pressure-transient-analysis.html` | Older DST analyzer v2.0 — superseded by Pro v2.12 |
