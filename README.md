...
| `flowsim-pro/` | **FlowSim Pro v1.1** — steady-state multiphase flow (Beggs-Brill VLP, nodal analysis, tubing/flowline selectors). FastAPI + Next.js. See `flowsim-pro/README.md` |

Open any `.html` file in a browser — no build step required. For FlowSim Pro, start the backend and frontend (see its README).
