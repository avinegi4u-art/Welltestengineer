...
| `dst-pressure-transient-analysis-pro-v2.15.html` | **DST PTA Pro v2.15** (open this one) — Kappa-style left-rail workspace with Analytical mosaic (Loglog · Results · Semilog · History), Generate analytical model dialog, Plotly charts + SVG offline fallback, auto-match, composite inversion, Bayesian uncertainty, office sign-off |
