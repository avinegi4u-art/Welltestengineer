...
| `dst-pressure-transient-analysis-pro-v2.14.html` | **DST PTA Pro v2.14** (open this one) — interactive Plotly PTA workspace (zoom/pan/select-fit) with SVG offline fallback; Horner & Bourdet, auto model match, boundary & composite inversion screening, Bayesian uncertainty, gating, office sign-off |
...
| `dst-pressure-transient-analysis.html` | Older DST analyzer v2.0 — superseded by Pro v2.14 |
